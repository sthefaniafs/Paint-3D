...
/**
 * @brief The Sculptor class desempenha o papel de realizar esculturas em blocos tridimensionais representados por matrizes digitais
...
{protected:
  ...
  public:
    ...
    /**
     * @brief Função membro que verifica se a posição [x,y,z] está com is0n ativado ou não
     * @param dimensão x
     * @param dimensão y
     * @param dimensão z
     */
    ...
    /**
     * @brief Função membro que retorna o valor da cor vermelha (red) no elemento da posição [i,j,k] do matriz de voxel
     * @param posição i
     * @param posição j
     * @param posição k
     */
    ...
    /**
     * @brief Função membro que retorna o valor da cor verde (green) no elemento da posição [i,j,k] do matriz de voxel
     * @param posição i
     * @param posição j
     * @param posição k
     */
    ...
    /**
     * @brief Função membro que retorna o valor da cor azul (blue) no elemento da posição [i,j,k] do matriz de voxel
     * @param posição i
     * @param posição j
     * @param posição k
     */
